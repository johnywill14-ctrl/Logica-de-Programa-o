programa {
      ...
      enquanto (verdadeiro) {
        ...
        se (numeroDigitado < 1 ou numeroDigitado > 100) {
          ...
          se (numeroDigitado == numeroSorteado) {
            ...
            atualizarMelhorJogador (nomeJogador, numeroTentativas, melhorPontuacao) 
            pare
          }
  ...
  funcao atualizarMelhorJogador (cadeia nomeJogador, inteiro numeroTentativas, inteiro melhorPontuacao ) {
